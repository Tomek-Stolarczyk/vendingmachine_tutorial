...
class Iface(object):
    def getBeverage(self, beverage_type):
        """
        Parameters:
         - beverage_type
...
class Client(Iface):
    ...
    def send_getBeverage(self, beverage_type):
...
class Processor(Iface, TProcessor):
    ...
    def process_getBeverage(self, seqid, iprot, oprot):
        ...
        result = getBeverage_result()
        try:
            result.success = self._handler.getBeverage(args.beverage_type)
...
class getBeverage_args(object):
    ...
    def __init__(self, beverage_type=None,):
    ...
    def write(self, oprot):
        ...
        if self.beverage_type is not None:
...
getBeverage_args.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'beverage_type', None, None, ),  # 1
)
