    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->beverage_type = (BeverageType::type)ecast8;
          this->__isset.beverage_type = true;
        } else {
...
uint32_t BeveragePreferenceService_getBeverage_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("beverage_type", ::apache::thrift::protocol::T_I32, 1);
  xfer += oprot->writeI32((int32_t)this->beverage_type);
...
void BeveragePreferenceServiceClient::getBeverage(std::string& _return, const BeverageType::type beverage_type)
{
  send_getBeverage(beverage_type);
  recv_getBeverage(_return);
}

void BeveragePreferenceServiceClient::send_getBeverage(const BeverageType::type beverage_type)
{
  int32_t cseqid = 0;
  ...
  args.beverage_type = &beverage_type;
  args.write(oprot_);
...
void BeveragePreferenceServiceProcessor::process_getBeverage(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->getBeverage(result.success, args.beverage_type);
...
void BeveragePreferenceServiceConcurrentClient::getBeverage(std::string& _return, const BeverageType::type beverage_type)
{
  int32_t seqid = send_getBeverage(beverage_type);
  recv_getBeverage(_return, seqid);
}

int32_t BeveragePreferenceServiceConcurrentClient::send_getBeverage(const BeverageType::type beverage_type)
{
